...
module.exports.onLoad = async function () {
    ...
    if (!existsSync(resolve(__dirname, 'cache', 'regular-font.ttf'))) await downloadFile("https://github.com/Sakibin/Font/raw/refs/heads/main/regular-font.ttf", resolve(__dirname, 'cache', 'regular-font.ttf'));
	if (!existsSync(resolve(__dirname, 'cache', 'bold-font.ttf'))) await downloadFile("https://github.com/Sakibin/Font/raw/refs/heads/main/bold-font.ttf", resolve(__dirname, 'cache', 'bold-font.ttf'));
	if (!existsSync(resolve(__dirname, 'cache', 'rankcard.png'))) await downloadFile("https://i.ibb.co.com/ccjwP5H/rankcard.jpg", resolve(__dirname, 'cache', 'rankcard.png'));
}
